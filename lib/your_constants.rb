# feel free to alter these constants as you need to
# if you want a user-defined field to use a pre-set list (i.e. for a dropdown menu),
#   put the list in the USER_FIELDS hash

module YourConstants
  USER_FIELDS = {
    'state' => [['Alaska', 'AK'], ['Alabama', 'AL'], ['Arkansas', 'AR'], ['Arizona', 'AZ'],
    ...
    'role' => ['SPDG Director', 'SPDG Evaluator', 'SPDG Coordinator', 'SPDG Staff', 'Other'],

    'mailing_state' => [['Alaska', 'AK'], ['Alabama', 'AL'], ['Arkansas', 'AR'], ['Arizona', 'AZ'],
        ['California', 'CA'], ['Colorado', 'CO'], ['Connecticut', 'CT'], ['District of Columbia', 'DC'],
        ['Delaware', 'DE'], ['Florida', 'FL'], ['Georgia', 'GA'], ['Hawaii', 'HI'], ['Iowa', 'IA'],
        ['Idaho', 'ID'], ['Illinois', 'IL'], ['Indiana', 'IN'], ['Kansas', 'KS'], ['Kentucky', 'KY'],
        ['Louisiana', 'LA'], ['Massachusetts', 'MA'], ['Maryland', 'MD'], ['Maine', 'ME'], ['Michigan', 'MI'],
